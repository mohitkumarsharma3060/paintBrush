    ...
    <div className="pt-4">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid md:grid-cols-2 gap-12">
          {/* Contact Form */}
          <div>
            <h2 className="text-2xl text-black font-bold mb-6">Send us a message</h2>
          ...
          {/* Contact Info */}
          <div>
            <h2 className="text-2xl text-black font-bold mb-6">Contact Information</h2>
            <div className="space-y-6">
              <div className="flex items-start">
                <Mail className="h-6 w-6 text-blue-600 mt-1 mr-4" />
                <div>
                  <h3 className="font-semibold text-gray-700 mb-1">Email</h3>
                  <p className="text-gray-600">info@telcobrushware.com</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">+91 9410495946, 9528541734</p>
                </div>
              </div>
